...
def gp_interp(xin, yin, sigmain=None, xpred=None, length_scale=None, fit_noise=True,
              n_restarts_optimizer=1, return_std=False, return_gp=False, **gprargs):
    '''
    ...
    Args:
        xin, yin (1d array-like) :
            input signal
        sigmain (optional, 1d array-like) :
            1 sigma uncertainty of yin
        xpred (optional, 1d array-like) :
            x-axis value of the output signal. If not specified, xin will be used.
        length_scale (optional, float) :
            a length scale of the RBF kernel to be used. The default value is the minimum interval of xin.
        fit_noise (optional, boolean) :
            If true, the global noise will be fitted as well.
        n_restarts_optimizer (optional, integer) :
            GP fit will be repeated for this value to avoid local minima.
        return_std (optional, boolean) :
            If true, the uncertainty of ypred will be output.
        return_gp (optional, boolean) :
            If true, the instance of the Gaussian Process Regressor will be returned.
    Returns:
